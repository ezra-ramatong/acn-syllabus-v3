...
Task 2.1 and Task 2.2 are a updates of Task 4 and 5 from <!-- {{< contentlink path="projects/katas/level-1" >}} --> _[todo] level 1 coding challenges; hugo link commented out _ . You should not create new files for them. Rather just update the existing code.
