...
9. What is a _relative_ path?
10. What is an _absolute_ path?
11. Explain the usage of the `man` command?
12. What command would you use to remove the directory _git-basic-exercises_? Assume that this directory is NOT empty.
13. Explain the use of _tab completion_?
